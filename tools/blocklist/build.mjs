...
const SOURCES = [
  ...
  { category: "privacy", name: "Peter Lowe's list",
    ...
    license: "McRae General Public License" },
  { category: "privacy", name: "NoCoin", url: "https://raw.githubusercontent.com/hoshsadiq/adblock-nocoin-list/master/nocoin.txt", license: "MIT" },
...
for (const src of SOURCES) {
  ...
  ingest(text, src);
  used.push({ category: src.category, name: src.name, url: src.url, license: src.license });
